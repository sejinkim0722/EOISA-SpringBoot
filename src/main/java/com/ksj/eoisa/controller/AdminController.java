...
import com.ksj.eoisa.service.AdminService;
...
public class AdminController {
	...
	/*member 전용 crud*/
	@RequestMapping(value="/member/{crud}", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)//produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	/*board 전용crud*/
	//notice
	@RequestMapping(value="/notice/{crud}", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)//produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	//free, review
	@RequestMapping(value="/board/{type}/{crud}", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)//produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	/*deal 전용crud*/
	@RequestMapping(value="/deal/{crud}", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)//produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
